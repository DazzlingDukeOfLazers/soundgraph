...
| Axoloti Core  | patches via arm-none-eabi-gcc 16 |  44 hardware-in-loop | — (analog loopback instead) | yes (on-board analyzer) | programming + limits proven 2026-08-25 (176 raw osc / 48 Sine nodes / 28 voices); see embedded/axoloti/ |
