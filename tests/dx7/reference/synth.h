...
// SoundGraph vendoring note: #warning is not a preprocessor directive MSVC accepts,
// and the oracle renders offline on one thread, where the barrier is moot anyway.
